constants
-----------
.. automodule:: dwell.constants
   :members:

The complete list of constants are listed below. In addition the following shortcuts
are included as module variables.

* c = speed of light in vacuum
* epsilon_0 = atomic unit of permittivity
* h = Planck constant
...
* Wien = Wien wavelength displacement law constant
...
hertz-hartree relationship                              1.519 829 846 0045e-16  0.0000000000076 e-16   E_h
